...

{
    ...
    'category': 'Sales',
    'author': 'Equick ERP',
    'summary': """sale order multi warehouse Sales multi warehouse on sale order line SO multi warehouse sale order warehouse multi picking multi transfer so multi picking sale picking by warehouse Sale Product Quantity Warehouse Wise""",
    'description': """
