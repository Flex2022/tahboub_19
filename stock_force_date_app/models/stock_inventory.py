...
class StockQuant(models.Model):
	...
	def _get_inventory_move_values(self, qty, location_id, location_dest_id, out=False):
		...
		if self.force_date:
			res.update({'force_date': self.force_date, })
		return res
...
class StockMove(models.Model):
	...
	force_date = fields.Datetime('Force Date', help='this field acts as transient to hold force date that will passed to date field.')
